...
from hrwros_factory_states.srdf_state_to_moveit import SrdfStateToMoveit as flexbe_manipulation_states__SrdfStateToMoveit
...
The three robots in the factory move to process the parts
	...
	def create(self):
		...
		_state_machine.userdata.conveyor_beld_speed = 100
		...
		with _state_machine:
			...
			OperatableStateMachine.add('starts the conveyor belt',
										...
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'speed': 'conveyor_beld_speed'})
			...
			OperatableStateMachine.add('Move R2 to pick',
										...
										transitions={'reached': 'Activate Gripper R2', 'planning_failed': 'failed', 'control_failed': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off},
